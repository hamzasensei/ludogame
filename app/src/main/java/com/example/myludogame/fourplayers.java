...
public class fourplayers extends AppCompatActivity {
    ...
    int i = 0, upsc = 0,
        ...
        yx1 = 0, yx2 = 0,
        gx1 = 0, gx2 = 0;
    int r1, r2, r3, r4, dfour = 0;
    int dicenumber[] = new int[6];
    int w = 0;
    Button play;
    ImageButton dice1, dice2, dice3, dice4;
    ImageView blue1, blue2, blue3, blue4;
    ImageView red1, red2, red3, red4;
    ImageView yellow1, yellow2, yellow3, yellow4;
    ImageView green1, green2, green3, green4;
     ...
     int gplayx1, gplayy1, gplayx2, gplayy2, gplayx3, gplayy3, gplayx4, gplayy4; //Green Tokens 1,2,3,4
     int rplayx1, rplayy1, rplayx2, rplayy2, rplayx3, rplayy3, rplayx4, rplayy4; //Green Tokens 1,2,3,4
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourplayers);

        new sqlb1(fourplayers.this).delete();
        new sqlb2(fourplayers.this).delete();
        new sqlb3(fourplayers.this).delete();
        new sqlb4(fourplayers.this).delete();

        new sqlb1(fourplayers.this).insert("0");
        new sqlb2(fourplayers.this).insert("0");
        new sqlb3(fourplayers.this).insert("0");
        new sqlb4(fourplayers.this).insert("0");
        ...
        mainlayout = new RelativeLayout(fourplayers.this);
        ...
        green1 = (ImageView) findViewById(R.id.greentoken1);
        green2 = (ImageView) findViewById(R.id.greentoken2);
        green3 = (ImageView) findViewById(R.id.greentoken3);
        green4 = (ImageView) findViewById(R.id.greentoken4);

        red1 = (ImageView) findViewById(R.id.redtoken1);
        red2 = (ImageView) findViewById(R.id.redtoken2);
        red3 = (ImageView) findViewById(R.id.redtoken3);
        red4 = (ImageView) findViewById(R.id.redtoken4);
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int r = height - (width);  //+60 for C7 & -60 for A30 && -120 for Laptop
                rh = r / 2;


//                tokendirection(blue2, (isize * 2), (rh + (isize * 11)));
//                tokendirection(blue3, (isize * 2), (rh + (isize * 11)));
//                tokendirection(blue4, (isize * 2), (rh + (isize * 11)));
...
//                tokendirection(yellow2, (isize * 11), (rh + (isize * 2)));
//                tokendirection(yellow3, (isize * 11), (rh + (isize * 2)));
//                tokendirection(yellow4, (isize * 11), (rh + (isize * 2)));
                ...
                tokendirection(green1, (isize * 11), (rh + (isize * 11)));
//                tokendirection(green2, (isize * 11), (rh + (isize * 11)));
//                tokendirection(green3, (isize * 11), (rh + (isize * 11)));
//                tokendirection(green4, (isize * 11), (rh + (isize * 11)));
                tokendirection(green2, (isize * 11), (rh + (isize * 12)));
                tokendirection(green3, (isize * 12), (rh + (isize * 11)));
                tokendirection(green4, (isize * 12), (rh + (isize * 12)));

                tokendirection(red1, (isize * 3), (rh + (isize * 2)));
                tokendirection(red2, (isize * 3), (rh + (isize * 3)));
                tokendirection(red3, (isize * 2), (rh + (isize * 3)));
//                tokendirection(red1, (isize * 2), (rh + (isize * 2)));
//                tokendirection(red2, (isize * 2), (rh + (isize * 2)));
//                tokendirection(red3, (isize * 2), (rh + (isize * 2)));
                tokendirection(red4, (isize * 2), (rh + (isize * 2)));
                ...
                gplayx1 = (int) green1.getX();
                gplayy1 = (int) green1.getY();
                gplayx2 = (int) green2.getX();
                gplayy2 = (int) green2.getY();
                gplayx3 = (int) green3.getX();
                gplayy3 = (int) green3.getY();
                gplayx4 = (int) green4.getX();
                gplayy4 = (int) green4.getY();

                rplayx1 = (int) red1.getX();
                rplayy1 = (int) red1.getY();
                rplayx2 = (int) red2.getX();
                rplayy2 = (int) red2.getY();
                rplayx3 = (int) red3.getX();
                rplayy3 = (int) red3.getY();
                rplayx4 = (int) red4.getX();
                rplayy4 = (int) red4.getY();
    ...
    dice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(fourplayers.this, R.raw.dicesound);
                mp.start();
                        ...
                        try {
                            for (i = 0; i < 7; i++) {
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        if (w < 5) {
                                            dice1.setImageDrawable(getResources().getDrawable(dicenumber[w]));
                                            if (i == 7) {
                                                ...
                                                dice1.setImageDrawable(getResources().getDrawable(dicenumber[r1]));
                                                mp.stop();

                                                if (r1 == 5) {movered(r1, red1, rplayx1, rplayy1);}  //DICE
                                                if (r1 == 0) {movered(r1, red1, rplayx1, rplayy1);}  //BLUE
                                                if (r1 == 1) {movered(r1, red1, rplayx1, rplayy1);}  //NUMBER
                                                if (r1 == 2) {movered(r1, red1, rplayx1, rplayy1);}  //ONCE
                                                if (r1 == 3) {movered(r1, red1, rplayx1, rplayy1);}
                                                if (r1 == 4) {movered(r1, red1, rplayx1, rplayy1);}

                                                if (r1 == 5) {movered(r1, red2, rplayx2, rplayy2);}  //DICE
                                                if (r1 == 0) {movered(r1, red2, rplayx2, rplayy2);}  //BlUE
                                                if (r1 == 1) {movered(r1, red2, rplayx2, rplayy2);}  //NUMBER
                                                if (r1 == 2) {movered(r1, red2, rplayx2, rplayy2);}  //TWO
                                                if (r1 == 3) {movered(r1, red2, rplayx2, rplayy2);}
                                                if (r1 == 4) {movered(r1, red2, rplayx2, rplayy2);}

                                                if (r1 == 5) {movered(r1, red3, rplayx3, rplayy3);}  //DICE
                                                if (r1 == 0) {movered(r1, red3, rplayx3, rplayy3);}  //BLUE
                                                if (r1 == 1) {movered(r1, red3, rplayx3, rplayy3);}  //MUMBER
                                                if (r1 == 2) {movered(r1, red3, rplayx3, rplayy3);}  //THREE
                                                if (r1 == 3) {movered(r1, red3, rplayx3, rplayy3);}
                                                if (r1 == 4) {movered(r1, red3, rplayx3, rplayy3);}

                                                if (r1 == 5) {movered(r1, red4, rplayx4, rplayy4);}  //DICE
                                                if (r1 == 0) {movered(r1, red4, rplayx4, rplayy4);}  //BLUE
                                                if (r1 == 1) {movered(r1, red4, rplayx4, rplayy4);}  //NUMBER
                                                if (r1 == 2) {movered(r1, red4, rplayx4, rplayy4);}  //FOUR
                                                if (r1 == 3) {movered(r1, red4, rplayx4, rplayy4);}
                                                if (r1 == 4) {movered(r1, red4, rplayx4, rplayy4);}
                                            }
                                        } else { w = 0; }
                                    }
                                });
                        ...
                        try {
                            for (i = 0; i < 7; i++) {
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        if (w < 5) {
                                            dice4.setImageDrawable(getResources().getDrawable(dicenumber[w]));
                                            if (i == 7) {
                                                Random rand = new Random();
                                                int number_random = rand.nextInt(6);
                                                r4 = number_random;
                                                ...
                                                dice4.setImageDrawable(getResources().getDrawable(dicenumber[r4]));
                                                mp.stop();

                                                if (r4 == 5) {movegreen(r4, green1, gplayx1, gplayy1);}  //DICE
                                                if (r4 == 0) {movegreen(r4, green1, gplayx1, gplayy1);}  //BLUE
                                                if (r4 == 1) {movegreen(r4, green1, gplayx1, gplayy1);}  //NUMBER
                                                if (r4 == 2) {movegreen(r4, green1, gplayx1, gplayy1);}  //ONCE
                                                if (r4 == 3) {movegreen(r4, green1, gplayx1, gplayy1);}
                                                if (r4 == 4) {movegreen(r4, green1, gplayx1, gplayy1);}

                                                if (r4 == 5) {movegreen(r4, green2, gplayx2, gplayy2);}  //DICE
                                                if (r4 == 0) {movegreen(r4, green2, gplayx2, gplayy2);}  //BlUE
                                                if (r4 == 1) {movegreen(r4, green2, gplayx2, gplayy2);}  //NUMBER
                                                if (r4 == 2) {movegreen(r4, green2, gplayx2, gplayy2);}  //TWO
                                                if (r4 == 3) {movegreen(r4, green2, gplayx2, gplayy2);}
                                                if (r4 == 4) {movegreen(r4, green2, gplayx2, gplayy2);}

                                                if (r4 == 5) {movegreen(r4, green3, gplayx3, gplayy3);}  //DICE
                                                if (r4 == 0) {movegreen(r4, green3, gplayx3, gplayy3);}  //BLUE
                                                if (r4 == 1) {movegreen(r4, green3, gplayx3, gplayy3);}  //MUMBER
                                                if (r4 == 2) {movegreen(r4, green3, gplayx3, gplayy3);}  //THREE
                                                if (r4 == 3) {movegreen(r4, green3, gplayx3, gplayy3);}
                                                if (r4 == 4) {movegreen(r4, green3, gplayx3, gplayy3);}

                                                if (r4 == 5) {movegreen(r4, green4, gplayx4, gplayy4);}  //DICE
                                                if (r4 == 0) {movegreen(r4, green4, gplayx4, gplayy4);}  //BLUE
                                                if (r4 == 1) {movegreen(r4, green4, gplayx4, gplayy4);}  //NUMBER
                                                if (r4 == 2) {movegreen(r4, green4, gplayx4, gplayy4);}  //FOUR
                                                if (r4 == 3) {movegreen(r4, green4, gplayx4, gplayy4);}
                                                if (r4 == 4) {movegreen(r4, green4, gplayx4, gplayy4);}
                                            }
                                        } else {
                                            w = 0;
                                        }
    ...
    public void moveblue(final int diceno, final ImageView imgblue, final int xdir, final int ydir) {
        ...
        if ((int) imgblue.getX() == xdir && (int) imgblue.getY() == ydir) {
            ...
            imgblue.startAnimation(blink());
            if (new sqlb1(fourplayers.this).show() + (diceno + 1) > 57) {
            ...
            if (new sqlb2(fourplayers.this).show() + (diceno + 1) > 57) {
            ...
            if (new sqlb3(fourplayers.this).show() + (diceno + 1) > 57) {
            ...
            if (new sqlb4(fourplayers.this).show() + (diceno + 1) > 57) {
...
//                id201.getLocationOnScreen(loc);
    ...
    public void moveyellow(final int diceno, final ImageView imgyellow, final int xdir, final int ydir) {
        if ((int) imgyellow.getX() == xdir && (int) imgyellow.getY() == ydir) {
            ...
            imgyellow.startAnimation(blink());
            if (new sqly1(fourplayers.this).show() + (diceno + 1) > 57) {
            ...
            if (new sqly2(fourplayers.this).show() + (diceno + 1) > 57) {
            ...
            if (new sqly3(fourplayers.this).show() + (diceno + 1) > 57) {
            ...
            if (new sqly4(fourplayers.this).show() + (diceno + 1) > 57) {
...
//                id201.getLocationOnScreen(loc);
                ...
                if ((int) imgyellow.getX() == xdir && (int) imgyellow.getY() == ydir)
                {
                    ...
                    y_x[6] = (int) imgyellow.getX() - (isize * 1);
                    y_y[6] = rh + (isize * 6);

                    y_x[7] = (int) imgyellow.getX() + (isize * 0);
                    y_y[7] = rh + (isize * 6);

                    y_x[8] = (int) imgyellow.getX() + (isize * 1);
                    y_y[8] = rh + (isize * 6);
                    ...
                    y_x[14] = (int) imgyellow.getX() + (isize * 1);
                    y_y[14] = rh + (isize * 8);

                    y_x[15] = (int) imgyellow.getX() + (isize * 0);
                    y_y[15] = rh + (isize * 8);

                    y_x[16] = (int) imgyellow.getX() - (isize * 1);
                    y_y[16] = rh + (isize * 8);
    ...
    public void movegreen(final int diceno, final ImageView imggreen, final int xdir, final int ydir) {
        if ((int) imggreen.getX() == xdir && (int) imggreen.getY() == ydir) {
            if (diceno == 5) {
                imggreen.startAnimation(blink());
            }
        } else {
            imggreen.startAnimation(blink());
            if (new sqlb1(fourplayers.this).show() + (diceno + 1) > 57) {
                if (green1.getAnimation() != null) {
                    green1.getAnimation().cancel();
                    green1.clearAnimation();
                    blink().setAnimationListener(null);
                }
            }
            if (new sqlb2(fourplayers.this).show() + (diceno + 1) > 57) {
                if (green2.getAnimation() != null) {
                    green2.getAnimation().cancel();
                    green2.clearAnimation();
                    blink().setAnimationListener(null);
                }
            }
            if (new sqlb3(fourplayers.this).show() + (diceno + 1) > 57) {
                if (green3.getAnimation() != null) {
                    green3.getAnimation().cancel();
                    green3.clearAnimation();
                    blink().setAnimationListener(null);
                }
            }
            if (new sqlb4(fourplayers.this).show() + (diceno + 1) > 57) {
                if (green4.getAnimation() != null) {
                    green4.getAnimation().cancel();
                    green4.clearAnimation();
                    blink().setAnimationListener(null);
                }
            }
        }
...
//                id201.getLocationOnScreen(loc);
                ...
                if ((int) imggreen.getX() == xdir && (int) imggreen.getY() == ydir) {
                    if (diceno == 5) {
                        tokendirection(imggreen, (int) imggreen.getX() + (isize * 2), rh + (isize * 8));
                    }

                    g_x[1] = (int) imggreen.getX() + (isize); //  * 1
                    g_y[1] = rh + (isize * 8);

                    g_x[2] = (int) imggreen.getX() ; // + (isize * 0)
                    g_y[2] = rh + (isize * 8);

                    g_x[3] = (int) imggreen.getX() - (isize); //  * 1
                    g_y[3] = rh + (isize * 8);

                    g_x[4] = (int) imggreen.getX() - (isize * 2);
                    g_y[4] = rh + (isize * 8);

                    g_x[5] = (int) imggreen.getX() - (isize * 3);
                    g_y[5] = rh + (isize * 9);

                    g_x[6] = (int) imggreen.getX() - (isize * 3);
                    g_y[6] = rh + (isize * 10);

                    g_x[7] = (int) imggreen.getX() - (isize * 3);
                    g_y[7] = rh + (isize * 11);

                    g_x[8] = (int) imggreen.getX() - (isize * 3);
                    g_y[8] = rh + (isize * 12);

                    g_x[9] = (int) imggreen.getX() - (isize * 3);
                    g_y[9] = rh + (isize * 13);

                    g_x[10] = (int) imggreen.getX() - (isize * 3);
                    g_y[10] = rh + (isize * 14);

                    g_x[11] = (int) imggreen.getX() - (isize * 4);
                    g_y[11] = rh + (isize * 14);

                    g_x[12] = (int) imggreen.getX() - (isize * 5);
                    g_y[12] = rh + (isize * 14);

                    g_x[13] = (int) imggreen.getX() - (isize * 5);
                    g_y[13] = rh + (isize * 13);

                    g_x[14] = (int) imggreen.getX() - (isize * 5);
                    g_y[14] = rh + (isize * 12);

                    g_x[15] = (int) imggreen.getX() - (isize * 5);
                    g_y[15] = rh + (isize * 11);

                    g_x[16] = (int) imggreen.getX() - (isize * 5);
                    g_y[16] = rh + (isize * 10);

                    g_x[17] = (int) imggreen.getX() - (isize * 5);
                    g_y[17] = rh + (isize * 9);

                    g_x[18] = (int) imggreen.getX() - (isize * 6);
                    g_y[18] = rh + (isize * 8);

                    g_x[19] = (int) imggreen.getX() - (isize * 7);
                    g_y[19] = rh + (isize * 8);

                    g_x[20] = (int) imggreen.getX() - (isize * 8);
                    g_y[20] = rh + (isize * 8);

                    g_x[21] = (int) imggreen.getX() - (isize * 9);
                    g_y[21] = rh + (isize * 8);

                    g_x[22] = (int) imggreen.getX() - (isize * 10);
                    g_y[22] = rh + (isize * 8);

                    g_x[23] = (int) imggreen.getX() - (isize * 11);
                    g_y[23] = rh + (isize * 8);

                    g_x[24] = (int) imggreen.getX() - (isize * 11);
                    g_y[24] = rh + (isize * 7);

                    g_x[25] = (int) imggreen.getX() - (isize * 11);
                    g_y[25] = rh + (isize * 6);

                    g_x[26] = (int) imggreen.getX() - (isize * 10);
                    g_y[26] = rh + (isize * 6);

                    g_x[27] = (int) imggreen.getX() - (isize * 9);
                    g_y[27] = rh + (isize * 6);

                    g_x[28] = (int) imggreen.getX() - (isize * 8);
                    g_y[28] = rh + (isize * 6);

                    g_x[29] = (int) imggreen.getX() - (isize * 7);
                    g_y[29] = rh + (isize * 6);

                    g_x[30] = (int) imggreen.getX() - (isize * 6);
                    g_y[30] = rh + (isize * 6);

                    g_x[31] = (int) imggreen.getX() - (isize * 5);
                    g_y[31] = rh + (isize * 5);

                    g_x[32] = (int) imggreen.getX() - (isize * 5);
                    g_y[32] = rh + (isize * 4);

                    g_x[33] = (int) imggreen.getX() - (isize * 5);
                    g_y[33] = rh + (isize * 3);

                    g_x[34] = (int) imggreen.getX() - (isize * 5);
                    g_y[34] = rh + (isize * 2);

                    g_x[35] = (int) imggreen.getX() - (isize * 5);
                    g_y[35] = rh + (isize * 1);

                    g_x[36] = (int) imggreen.getX() - (isize * 5);
                    g_y[36] = rh + (isize * 0);

                    g_x[37] = (int) imggreen.getX() - (isize * 4);
                    g_y[37] = rh + (isize * 0);

                    g_x[38] = (int) imggreen.getX() - (isize * 3);
                    g_y[38] = rh + (isize * 0);

                    g_x[39] = (int) imggreen.getX() - (isize * 3);
                    g_y[39] = rh + (isize * 1);

                    g_x[40] = (int) imggreen.getX() - (isize * 3);
                    g_y[40] = rh + (isize * 2);

                    g_x[41] = (int) imggreen.getX() - (isize * 3);
                    g_y[41] = rh + (isize * 3);

                    g_x[42] = (int) imggreen.getX() - (isize * 3);
                    g_y[42] = rh + (isize * 4);

                    g_x[43] = (int) imggreen.getX() - (isize * 3);
                    g_y[43] = rh + (isize * 5);

                    g_x[44] = (int) imggreen.getX() - (isize * 2);
                    g_y[44] = rh + (isize * 6);

                    g_x[45] = (int) imggreen.getX() - (isize * 1);
                    g_y[45] = rh + (isize * 6);

                    g_x[46] = (int) imggreen.getX() + (isize * 0);
                    g_y[46] = rh + (isize * 6);

                    g_x[47] = (int) imggreen.getX() + (isize * 1);
                    g_y[47] = rh + (isize * 6);

                    g_x[48] = (int) imggreen.getX() + (isize * 2);
                    g_y[48] = rh + (isize * 6);

                    g_x[49] = (int) imggreen.getX() + (isize * 3);
                    g_y[49] = rh + (isize * 6);

                    g_x[50] = (int) imggreen.getX() + (isize * 3);
                    g_y[50] = rh + (isize * 7);

                    g_x[51] = (int) imggreen.getX() + (isize * 2);
                    g_y[51] = rh + (isize * 7);

                    g_x[52] = (int) imggreen.getX() + (isize * 1);
                    g_y[52] = rh + (isize * 7);

                    g_x[53] = (int) imggreen.getX() + (isize * 0);
                    g_y[53] = rh + (isize * 7);

                    g_x[54] = (int) imggreen.getX() - (isize * 1);
                    g_y[54] = rh + (isize * 7);

                    g_x[55] = (int) imggreen.getX() - (isize * 2);
                    g_y[55] = rh + (isize * 7);

                    g_x[56] = (int) imggreen.getX() - (isize * 3);
                    g_y[56] = rh + (isize * 7);
                    ...
                    if (upsc == 0) {
                                ...
                                try {
                                    for (int yu = 0; yu < diceno + 1; yu++) {
                                        ...
                                        runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                tokendirection(imggreen, g_x[finalYu], g_y[(finalYu)]);
                                            }
                                        });
                                    }
                                } catch (InterruptedException e) {
                        ...
                        if ((int) imggreen.getX() == g_x[1] && (int) imggreen.getY() == g_y[1] + (isize)) {
                    ...
                    int[] values = new int[2];
                    imggreen.getLocationOnScreen(values);

                    for (int iu = 0; iu < 56; iu++) {

                        if ((int) imggreen.getX() == g_x[iu] && (int) imggreen.getY() == g_y[iu]) {
                                    ...
                                    try {
                                        for (int ac = 0; ac < (diceno + 2); ac++) {
                                            ...
                                            runOnUiThread(new Runnable() {
                                                @Override
                                                public void run() {
                                                    tokendirection(imggreen, g_x[gx1 + gx2], g_y[gx1 + gx2]);
                                                }
                                            });
                                        }
                                    } catch (InterruptedException e) {
    ...
    public void movered(final int diceno, final ImageView imgred, final int xdir, final int ydir) {
        if ((int) imgred.getX() == xdir && (int) imgred.getY() == ydir) {
            if (diceno == 5) {
                imgred.startAnimation(blink());
            }
        } else {
            imgred.startAnimation(blink());
            if (new sqlb1(fourplayers.this).show() + (diceno + 1) > 57) {
                if (red1.getAnimation() != null) {
                    red1.getAnimation().cancel();
                    red1.clearAnimation();
                    blink().setAnimationListener(null);
                }
            }
            if (new sqlb2(fourplayers.this).show() + (diceno + 1) > 57) {
                if (red2.getAnimation() != null) {
                    red2.getAnimation().cancel();
                    red2.clearAnimation();
                    blink().setAnimationListener(null);
                }
            }
            if (new sqlb3(fourplayers.this).show() + (diceno + 1) > 57) {
                if (red3.getAnimation() != null) {
                    red3.getAnimation().cancel();
                    red3.clearAnimation();
                    blink().setAnimationListener(null);
                }
            }
            if (new sqlb4(fourplayers.this).show() + (diceno + 1) > 57) {
                if (red4.getAnimation() != null) {
                    red4.getAnimation().cancel();
                    red4.clearAnimation();
                    blink().setAnimationListener(null);
                }
            }
...
//                id201.getLocationOnScreen(loc);
                ...
                if ((int) imgred.getX() == xdir && (int) imgred.getY() == ydir) {
                    if (diceno == 5)
                    {
                        tokendirection(imgred, (int) imgred.getX() - (isize), rh + (isize * 6));
                    }
                    else
                    {
                    ...
                    r_x[1] = (int) imgred.getX() + (isize * 0);
                    r_y[1] = rh + (isize * 6);

                    r_x[2] = (int) imgred.getX() + (isize * 1);
                    r_y[2] = rh + (isize * 6);

                    r_x[3] = (int) imgred.getX() + (isize * 2);
                    r_y[3] = rh + (isize * 6);

                    r_x[4] = (int) imgred.getX() + (isize * 3);
                    r_y[4] = rh + (isize * 6);

                    r_x[5] = (int) imgred.getX() + (isize * 4);
                    r_y[5] = rh + (isize * 5);

                    r_x[6] = (int) imgred.getX() + (isize * 4);
                    r_y[6] = rh + (isize * 4);

                    r_x[7] = (int) imgred.getX() + (isize * 4);
                    r_y[7] = rh + (isize * 3);

                    r_x[8] = (int) imgred.getX() + (isize * 4);
                    r_y[8] = rh + (isize * 2);

                    r_x[9] = (int) imgred.getX() + (isize * 4);
                    r_y[9] = rh + (isize * 1);

                    r_x[10] = (int) imgred.getX() + (isize * 4);
                    r_y[10] = rh - (isize * 0);

                    r_x[11] = (int) imgred.getX() + (isize * 5);
                    r_y[11] = rh - (isize * 0);

                    r_x[12] = (int) imgred.getX() + (isize * 6);
                    r_y[12] = rh - (isize * 0);

                    r_x[13] = (int) imgred.getX() + (isize * 6);
                    r_y[13] = rh + (isize * 1);

                    r_x[14] = (int) imgred.getX() + (isize * 6);
                    r_y[14] = rh + (isize * 2);

                    r_x[15] = (int) imgred.getX() + (isize * 6);
                    r_y[15] = rh + (isize * 3);

                    r_x[16] = (int) imgred.getX() + (isize * 6);
                    r_y[16] = rh + (isize * 4);

                    r_x[17] = (int) imgred.getX() + (isize * 6);
                    r_y[17] = rh + (isize * 5);

                    r_x[18] = (int) imgred.getX() + (isize * 7);
                    r_y[18] = rh + (isize * 6);

                    r_x[19] = (int) imgred.getX() + (isize * 8);
                    r_y[19] = rh + (isize * 6);

                    r_x[20] = (int) imgred.getX() + (isize * 9);
                    r_y[20] = rh + (isize * 6);

                    r_x[21] = (int) imgred.getX() + (isize * 10);
                    r_y[21] = rh + (isize * 6);

                    r_x[22] = (int) imgred.getX() + (isize * 11);
                    r_y[22] = rh + (isize * 6);

                    r_x[23] = (int) imgred.getX() + (isize * 12);
                    r_y[23] = rh + (isize * 6);

                    r_x[24] = (int) imgred.getX() + (isize * 12);
                    r_y[24] = rh + (isize * 7);

                    r_x[25] = (int) imgred.getX() + (isize * 12);
                    r_y[25] = rh + (isize * 8);

                    r_x[26] = (int) imgred.getX() + (isize * 11);
                    r_y[26] = rh + (isize * 8);

                    r_x[27] = (int) imgred.getX() + (isize * 10);
                    r_y[27] = rh + (isize * 8);

                    r_x[28] = (int) imgred.getX() + (isize * 9);
                    r_y[28] = rh + (isize * 8);

                    r_x[29] = (int) imgred.getX() + (isize * 8);
                    r_y[29] = rh + (isize * 8);

                    r_x[30] = (int) imgred.getX() + (isize * 7);
                    r_y[30] = rh + (isize * 8);

                    r_x[31] = (int) imgred.getX() + (isize * 6);
                    r_y[31] = rh + (isize * 9);

                    r_x[32] = (int) imgred.getX() + (isize * 6);
                    r_y[32] = rh + (isize * 10);

                    r_x[33] = (int) imgred.getX() + (isize * 6);
                    r_y[33] = rh + (isize * 11);

                    r_x[34] = (int) imgred.getX() + (isize * 6);
                    r_y[34] = rh + (isize * 12);

                    r_x[35] = (int) imgred.getX() + (isize * 6);
                    r_y[35] = rh + (isize * 13);

                    r_x[36] = (int) imgred.getX() + (isize * 6);
                    r_y[36] = rh + (isize * 14);

                    r_x[37] = (int) imgred.getX() + (isize * 5);
                    r_y[37] = rh + (isize * 14);

                    r_x[38] = (int) imgred.getX() + (isize * 4);
                    r_y[38] = rh + (isize * 14);

                    r_x[39] = (int) imgred.getX() + (isize * 4);
                    r_y[39] = rh + (isize * 13);

                    r_x[40] = (int) imgred.getX() + (isize * 4);
                    r_y[40] = rh + (isize * 12);

                    r_x[41] = (int) imgred.getX() + (isize * 4);
                    r_y[41] = rh + (isize * 11);

                    r_x[42] = (int) imgred.getX() + (isize * 4);
                    r_y[42] = rh + (isize * 10);

                    r_x[43] = (int) imgred.getX() + (isize * 4);
                    r_y[43] = rh + (isize * 9);

                    r_x[44] = (int) imgred.getX() + (isize * 3);
                    r_y[44] = rh + (isize * 8);

                    r_x[45] = (int) imgred.getX() + (isize * 2);
                    r_y[45] = rh + (isize * 8);

                    r_x[46] = (int) imgred.getX() + (isize * 1);
                    r_y[46] = rh + (isize * 8);

                    r_x[47] = (int) imgred.getX() - (isize * 0);
                    r_y[47] = rh + (isize * 8);

                    r_x[48] = (int) imgred.getX() - (isize * 1);
                    r_y[48] = rh + (isize * 8);

                    r_x[49] = (int) imgred.getX() - (isize * 2);
                    r_y[49] = rh + (isize * 8);

                    r_x[50] = (int) imgred.getX() - (isize * 2);
                    r_y[50] = rh + (isize * 7);

                    r_x[51] = (int) imgred.getX() - (isize);
                    r_y[51] = rh + (isize * 7);

                    r_x[52] = (int) imgred.getX() + (isize * 0);
                    r_y[52] = rh + (isize * 7);

                    r_x[53] = (int) imgred.getX() + (isize * 1);
                    r_y[53] = rh + (isize * 7);

                    r_x[54] = (int) imgred.getX() + (isize * 2);
                    r_y[54] = rh + (isize * 7);

                    r_x[55] = (int) imgred.getX() + (isize * 3);
                    r_y[55] = rh + (isize * 7);

                    r_x[56] = (int) imgred.getX() + (isize * 4);
                    r_y[56] = rh + (isize * 7);
                    ...
                    if (upsc == 0) {
                                ...
                                try {
                                    for (int yu = 0; yu < diceno + 1; yu++) {
                                        ...
                                        runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                tokendirection(imgred, r_x[finalYu], r_y[(finalYu)]);
                                            }
                                        });
                                    }
                                } catch (InterruptedException e) {
                        ...
                        if ((int) imgred.getX() == r_x[1] && (int) imgred.getY() == r_y[1] + (isize)) {
                    ...
                    int[] values = new int[2];
                    imgred.getLocationOnScreen(values);

                    for (int iu = 0; iu < 56; iu++) {

                        if ((int) imgred.getX() == r_x[iu] && (int) imgred.getY() == r_y[iu]) {
                                    ...
                                    try {
                                        for (int ac = 0; ac < (diceno + 2); ac++) {
                                            ...
                                            runOnUiThread(new Runnable() {
                                                @Override
                                                public void run() {
                                                    tokendirection(imgred, r_x[rx1 + rx2], r_y[rx1 + rx2]);
                                                }
                                            });
                                        }
                                    } catch (InterruptedException e) {
